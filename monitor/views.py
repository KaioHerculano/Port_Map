...
class DashboardView(LoginRequiredMixin, generic.ListView):
    ...
    def get_queryset(self):
        ...
        return DashboardService.get_filtered_queryset(
            search_query, status_filter, group_id
        )
    ...
    def get_context_data(self, **kwargs: Any) -> Dict[str, Any]:
        ...
        context["recent_logs"] = MonitorLog.objects.select_related(
            "target", "target__group"
...
class UpdateTargetView(LoginRequiredMixin, generic.UpdateView):
    ...
    def form_valid(self, form):
        ...
        if (
            MonitorTarget.objects.filter(host=host, port=port)
